...
function getChangedFiles() {
    ...
    const { stdout } = (0, child_process_1.spawnSync)('git', ['diff', '--name-status', '--diff-filter=d', `${base}..HEAD`], { stdio: ['ignore', 'pipe', 'inherit'], encoding: 'utf-8' });
...
function fetchComparisonBase() {
    ...
    if (!hasCommit(base)) {
        if (base.startsWith('HEAD')) {
            (0, child_process_1.spawnSync)('git', ['fetch', 'origin', '--deepen=1'], { stdio: 'inherit' });
        }
        else {
            (0, child_process_1.spawnSync)('git', ['fetch', 'origin', base], { stdio: 'inherit' });
            (0, child_process_1.spawnSync)('git', ['branch', base, 'FETCH_HEAD'], { stdio: 'inherit' });
        }
    }
    return base;
}
...
function detect() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const globber = yield glob.create(packages.join('\n'));
        try {
    ...
    for (const results of detected) {
        ...
        for (const [base, workspace] of results) {
            if (!merged.has(base)) {
                ...
                merged.set(base, Object.assign(Object.assign(Object.assign({}, existing), workspace), { dependencies: new Set([
...
function detect() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (decl == null)
            return null;
        const workspaces = new Map();
        const globber = yield glob.create(decl.packages.join('\n'));
        try {
            for (var _d = true, _e = __asyncValues(globber.globGenerator()), _f; _f = yield _e.next(), _a = _f.done, !_a;) {
                _c = _f.value;
                _d = false;
